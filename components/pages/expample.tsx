...
export default function Page1() {
  ...
  function onShow() {
    let t = 0;
    const stepSlow = 1000; // 逐行间隔更慢，避免“出现过快”问题
    ...
    reveal(".pt1 p:nth-child(5)", (t += stepSlow));
  ...
  return (
    <PageWrapper pageNumber={PAGE_NUMBER} onShow={handleShow} className="page3" onAppendNext={() => setShowHint(false)}>
